...
public class VideoDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie =
                (News) getActivity().getIntent().getSerializableExtra(DetailsActivity.MOVIE);
        list = getActivity().getIntent().getStringArrayListExtra("alldata");
    ...
    private void setupDetailsOverviewRow() {
        ...
        actionAdapter.add(
                new Action(ACTION_WATCH_TRAILER,mSelectedMovie.title));
    ...
    private void setupRelatedMovieListRow() {
      ...
      //  List<News> list = MovieList.getList();
