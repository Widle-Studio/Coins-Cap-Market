...
public class USD
{
    ...
    {
        return "ClassPojo [LASTUPDATE = "+LASTUPDATE+", PRICE = "+PRICE+", VOLUME24HOUR = "+VOLUME24HOUR+", FROMSYMBOL = "+FROMSYMBOL+", TOTALVOLUME24H = "+TOTALVOLUME24H+", MARKET = "+MARKET+", LOW24HOUR = "+LOW24HOUR+", VOLUMEDAYTO = "+VOLUMEDAYTO+", LOWDAY = "+LOWDAY+", VOLUME24HOURTO = "+VOLUME24HOURTO+", HIGHDAY = "+HIGHDAY+", OPEN24HOUR = "+OPEN24HOUR+", CHANGE24HOUR = "+CHANGE24HOUR+", SUPPLY = "+SUPPLY+", TOTALVOLUME24HTO = "+TOTALVOLUME24HTO+", CHANGEPCT24HOUR = "+CHANGEPCT24HOUR+", LASTTRADEID = "+LASTTRADEID+", OPENDAY = "+OPENDAY+", VOLUMEDAY = "+VOLUMEDAY+", CHANGEDAY = "+CHANGEDAY+", LASTVOLUMETO = "+LASTVOLUMETO+", HIGH24HOUR = "+HIGH24HOUR+", CHANGEPCTDAY = "+CHANGEPCTDAY+", MKTCAP = "+MKTCAP+", LASTMARKET = "+LASTMARKET+", LASTVOLUME = "+LASTVOLUME+", TOSYMBOL = "+TOSYMBOL+"]";
    }
}
